...
g++ -v -static -static-libgcc -static-libstdc++ -L"libs/" -o Lara.exe Lara.o download.o Thread.o IRCHandler.o IRCSocket.o IRCClient.o icon.o -L. -lchilkat-9.5.0 -lpthreadGCE2 -lpthreadGC2 -lcrypt32 -lws2_32 -ldnsapi -lwinmm -lwininet -lopencv_core249 -lopencv_highgui249
rm -v *.o  
cd "C:\Users\Cameron\Desktop\code projects\C Programming\C++\WIP\AI(Home use)"