...
g++ -v -time -fpermissive -I"C:\tools\sfml-mingw64\SFML-2.5.1\include" -Iinclude/ -I"C:\Development_tools\Interpreters\Python35-32bit\include" -I"C:\Program Files (x86)\Java\jdk1.8.0_162\include" -I"C:\Program Files (x86)\Java\jdk1.8.0_162\include\win32" -c Lara.cpp -o Lara.o -Wwrite-strings -Wdeprecated-declarations -Wfatal-errors
